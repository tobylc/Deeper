            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <Button
                  ...
                  variant="outline"
                  size="lg"
                  className="w-full bg-[#1877F2] hover:bg-[#166FE5] text-white border-[#1877F2] font-inter font-medium py-3 rounded-3xl transition-all duration-200"
                >
                ...
                <Button
                  ...
                  variant="outline"
                  size="lg"
                  className="w-full bg-black hover:bg-gray-900 text-white border-black font-inter font-medium py-3 rounded-3xl transition-all duration-200"
                >
