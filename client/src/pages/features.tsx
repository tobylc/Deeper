    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link href="/features" className="text-primary font-inter font-medium">
                Features
              </Link>
      ...
      <section className="pt-24 pb-16 bg-gradient-to-br from-slate-50 to-blue-50">
        <div className="max-w-6xl mx-auto px-6 lg:px-8 text-center">
          <div className="mb-8">
            ...
            <h1 className="text-4xl lg:text-6xl font-space font-bold text-gray-900 mb-6 leading-tight">
          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-16">
            ...
            <Card className="border-2 border-primary/20 bg-primary/5">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-2xl font-space font-bold text-gray-900 mb-4">Exclusively Two People</h3>
            ...
            <Card className="border-2 border-secondary/20 bg-secondary/5">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-2xl font-space font-bold text-gray-900 mb-4">Turn-Based Dialogue</h3>
                <p className="text-gray-600 mb-6 leading-relaxed">
            ...
            <Card className="border-2 border-accent/20 bg-accent/5">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-2xl font-space font-bold text-gray-900 mb-4">Expertly Curated Questions</h3>
                <p className="text-gray-600 mb-6 leading-relaxed">
        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="flex items-start space-x-4 p-6 bg-white rounded-2xl shadow-sm">
              ...
              <div>
                <h3 className="text-xl font-space font-semibold text-gray-900 mb-2">Mutual Consent System</h3>
            ...
            <div className="flex items-start space-x-4 p-6 bg-white rounded-2xl shadow-sm">
              ...
              <div>
                <h3 className="text-xl font-space font-semibold text-gray-900 mb-2">Conversation Timeline</h3>
                <p className="text-gray-600 leading-relaxed">
            ...
            <div className="flex items-start space-x-4 p-6 bg-white rounded-2xl shadow-sm">
              ...
              <div>
                <h3 className="text-xl font-space font-semibold text-gray-900 mb-2">Relationship-Specific Design</h3>
                <p className="text-gray-600 leading-relaxed">
            ...
            <div className="flex items-start space-x-4 p-6 bg-white rounded-2xl shadow-sm">
              ...
              <div>
                <h3 className="text-xl font-space font-semibold text-gray-900 mb-2">Privacy by Design</h3>
                <p className="text-gray-600 leading-relaxed">
            ...
            <div className="flex items-start space-x-4 p-6 bg-white rounded-2xl shadow-sm">
              ...
              <div>
                <h3 className="text-xl font-space font-semibold text-gray-900 mb-2">Intentional Pacing</h3>
                <p className="text-gray-600 leading-relaxed">
            ...
            <div className="flex items-start space-x-4 p-6 bg-white rounded-2xl shadow-sm">
              ...
              <div>
                <h3 className="text-xl font-space font-semibold text-gray-900 mb-2">Smart Question Suggestions</h3>
                <p className="text-gray-600 leading-relaxed">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-space font-bold text-gray-900 mb-8">
            Why meaningful conversation matters
          </h2>
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div>
              <div className="text-4xl font-bold text-primary mb-2">73%</div>
              <p className="text-gray-600">of people feel lonely despite being connected online</p>
            </div>
            <div>
              <div className="text-4xl font-bold text-secondary mb-2">89%</div>
              <p className="text-gray-600">crave deeper, more meaningful relationships</p>
            </div>
            <div>
              <div className="text-4xl font-bold text-accent mb-2">2x</div>
              <p className="text-gray-600">stronger bonds form through structured dialogue</p>
            </div>
          </div>
